...
By the end of this course, you'll have the skills and knowledge to develop your own applications, whether they're web-based, mobile, or desktop. We look forward to helping you embark on your journey into the exciting world of application development!presentation, JavaScript for client-side logics, PHP for server-side logics and MySQL for data processing. At the end of the course, the students should be able to apply the web base technologies and then implement it all in the creating functional data-centric online system project.

## ❤️ [Kerja kursus](images/SECV1223.pdf)
